...
base_profile = {
    ...
    "Education": "Bachelors",
    "Sal_Range": "> ₹ 40 Lakh <= ₹ 60 Lakh",
    "Coverage": "Balanced",
    "Veh_Usage": "Business",
    "Annual_Miles_Range": "<= 7.5 K",
    "Vehicl_Cost_Range": "> ₹ 10 Lakh <= ₹ 20 Lakh",
    "Re_Quote": "No",
    "Quoted_Premium": 500.0,
    "Proposed_Premium": 500.0,
}
for i in range(5):
    p = base_profile.copy()
