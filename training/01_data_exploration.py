...
print("\n--- Target Variables ---")
print(
    "1. Target for Risk Profiler (Risk_Tier - assumes it exists or we need to derive it)"
)
if "Risk_Tier" in df.columns:
    print(df["Risk_Tier"].value_counts(normalize=True))
else:
    print(
        "Risk_Tier column not found - we may need to engineer this based on accidents/citations."
    )
